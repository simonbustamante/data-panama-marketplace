 ...
 */
final class Version20240522223948 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE browsing_history (id INT GENERATED BY DEFAULT AS IDENTITY NOT NULL, history_id VARCHAR(255) NOT NULL, visited_date TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, product_id_id INT DEFAULT NULL, user_id_id INT DEFAULT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('CREATE TABLE category (id INT GENERATED BY DEFAULT AS IDENTITY NOT NULL, category_id VARCHAR(255) NOT NULL, name VARCHAR(255) NOT NULL, description VARCHAR(255) NOT NULL, PRIMARY KEY(id))');
        $this->addSql('CREATE TABLE coupon (id INT GENERATED BY DEFAULT AS IDENTITY NOT NULL, coupon_id VARCHAR(255) NOT NULL, code VARCHAR(255) NOT NULL, description VARCHAR(255) NOT NULL, discount_amount NUMERIC(10, 5) NOT NULL, discount_type VARCHAR(255) NOT NULL, start_date TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, end_date TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, active BOOLEAN NOT NULL, PRIMARY KEY(id))');
        $this->addSql('CREATE TABLE "order" (id INT GENERATED BY DEFAULT AS IDENTITY NOT NULL, order_id VARCHAR(255) NOT NULL, order_date TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, status VARCHAR(255) NOT NULL, total NUMERIC(10, 5) NOT NULL, user_id_id INT DEFAULT NULL, PRIMARY KEY(id))');
        $this->addSql('CREATE INDEX IDX_F52993989D86650F ON "order" (user_id_id)');
        $this->addSql('CREATE TABLE order_detail (id INT GENERATED BY DEFAULT AS IDENTITY NOT NULL, order_detail_id VARCHAR(255) NOT NULL, quantity INT NOT NULL, price NUMERIC(10, 5) NOT NULL, order_id_id INT DEFAULT NULL, product_id_id INT DEFAULT NULL, store_id_id INT DEFAULT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('CREATE TABLE payment (id INT GENERATED BY DEFAULT AS IDENTITY NOT NULL, payment_id VARCHAR(255) NOT NULL, payment_date TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, amount NUMERIC(10, 5) NOT NULL, method VARCHAR(255) NOT NULL, order_id_id INT DEFAULT NULL, PRIMARY KEY(id))');
        $this->addSql('CREATE INDEX IDX_6D28840DFCDAEAAA ON payment (order_id_id)');
        $this->addSql('CREATE TABLE product (id INT GENERATED BY DEFAULT AS IDENTITY NOT NULL, product_id VARCHAR(255) NOT NULL, name VARCHAR(255) NOT NULL, description VARCHAR(255) NOT NULL, price NUMERIC(10, 5) NOT NULL, stock_quantity INT NOT NULL, image_url VARCHAR(255) DEFAULT NULL, created_date TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, category_id_id INT DEFAULT NULL, store_id_id INT DEFAULT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('CREATE TABLE product_review (id INT GENERATED BY DEFAULT AS IDENTITY NOT NULL, review_id VARCHAR(255) NOT NULL, rating INT NOT NULL, comment VARCHAR(255) NOT NULL, review_date TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, product_id_id INT DEFAULT NULL, user_id_id INT DEFAULT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('CREATE TABLE recommendation (id INT GENERATED BY DEFAULT AS IDENTITY NOT NULL, recommendation_id VARCHAR(255) NOT NULL, created_date TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, reason VARCHAR(255) NOT NULL, status VARCHAR(255) NOT NULL, product_id_id INT DEFAULT NULL, user_id_id INT DEFAULT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('CREATE TABLE returns (id INT GENERATED BY DEFAULT AS IDENTITY NOT NULL, return_id VARCHAR(255) NOT NULL, return_date TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, status VARCHAR(255) NOT NULL, reason VARCHAR(255) NOT NULL, order_id_id INT DEFAULT NULL, product_id_id INT DEFAULT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('CREATE TABLE shipment (id INT GENERATED BY DEFAULT AS IDENTITY NOT NULL, shipment_id VARCHAR(255) NOT NULL, shipment_date TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, carrier VARCHAR(255) NOT NULL, tracking_number VARCHAR(255) NOT NULL, order_id_id INT DEFAULT NULL, PRIMARY KEY(id))');
        $this->addSql('CREATE INDEX IDX_2CB20DCFCDAEAAA ON shipment (order_id_id)');
        $this->addSql('CREATE TABLE store (id INT GENERATED BY DEFAULT AS IDENTITY NOT NULL, store_id VARCHAR(255) NOT NULL, name VARCHAR(255) NOT NULL, description VARCHAR(255) DEFAULT NULL, created_date TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, active BOOLEAN NOT NULL, user_id INT DEFAULT NULL, PRIMARY KEY(id))');
        $this->addSql('CREATE INDEX IDX_FF575877A76ED395 ON store (user_id)');
        $this->addSql('CREATE TABLE store_review (id INT GENERATED BY DEFAULT AS IDENTITY NOT NULL, review_id VARCHAR(255) NOT NULL, rating INT NOT NULL, comment VARCHAR(255) NOT NULL, review_date TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, store_id_id INT DEFAULT NULL, user_id_id INT DEFAULT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('CREATE TABLE "user" (id INT GENERATED BY DEFAULT AS IDENTITY NOT NULL, email VARCHAR(180) NOT NULL, roles JSON NOT NULL, password VARCHAR(255) NOT NULL, user_id VARCHAR(255) DEFAULT NULL, phone VARCHAR(255) DEFAULT NULL, address VARCHAR(255) DEFAULT NULL, sex VARCHAR(255) DEFAULT NULL, name VARCHAR(255) DEFAULT NULL, PRIMARY KEY(id))');
        $this->addSql('CREATE UNIQUE INDEX UNIQ_IDENTIFIER_EMAIL ON "user" (email)');
        $this->addSql('CREATE UNIQUE INDEX UNIQ_IDENTIFIER_USER_ID ON "user" (user_id)');
        $this->addSql('CREATE TABLE wishlist (id INT GENERATED BY DEFAULT AS IDENTITY NOT NULL, wishlist_id VARCHAR(255) NOT NULL, added_date TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, product_id_id INT DEFAULT NULL, user_id_id INT DEFAULT NULL, PRIMARY KEY(id))');
